...
if (w < 768) {
	var center_qud = new google.maps.LatLng(18.459260, 79.136240); // for mobile screen center
} else {
	var center_qud = new google.maps.LatLng(18.459260, 79.136240);
}
...
function initialize() {
	...
	var marker = new google.maps.Marker({
		map: map,
		icon: img_icon,
		position: new google.maps.LatLng(18.459260, 79.136240) //change the coordinates
	});
